...
const EditTask = () => {
    ...
    useEffect(() => {
        ...
        (async () => {
            ...
            try {
                ...
                const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/v1/tasks/get-task-by-id`, {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/v1/tasks/edit-task`, {
    ...
    return (
        ...
        <div className='min-h-[87vh]'>
            ...
            {loading ?  <div role="status" className='flex justify-center text-center py-12 w-[100vw]'>
                ...
                <section id="add-task" className="px-6 md:px-20 py-12 bg-white">
                    <div className="max-w-4xl mx-auto bg-gray-100 p-8 rounded-2xl shadow-lg">
                        <h2 className="text-3xl font-bold text-gray-800 mb-10 text-center">Update Your Task</h2>
